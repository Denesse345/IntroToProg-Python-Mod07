...
#   <Denesse Citlaly Gomez>,<6/3/24>,<Assignment 07>
# ------------------------------------------------------------------------------------------ #
import json #Note: There must be an existing data for the code to run
...
----------------------------------------- 
'''
FILE_NAME: str = "Enrollments.json" #Note: Constant values do not change throughout the program
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list[Student])-> list[Student]:
        ...
        ChangeLog: (Who, When, What)
        DGomez, 6/3/24,Created function
        ...
        return student_data
    @staticmethod
    def write_data_to_file(file_name: str, student_data: list[Student])-> list[Student]:
...
class IO:
    ...
    ChangeLog: (Who, When, What)
    RRoot, 1.1.2030,Created Class
    RRoot, 1.1.2030,Added menu output and input functions
    RRoot, 1.1.2030,Added a function to display the data
    RRoot, 1.1.2030,Added a function to display custom error messages
    """
